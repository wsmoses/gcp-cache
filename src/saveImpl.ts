...
export async function saveImpl(
    ...
    try {
        ...
        const gcpBucket =
            stateProvider.getState(State.GcpBucket) ||
            core.getInput(Inputs.GcpBucket);
        const gcpPrefix =
            stateProvider.getState(State.GcpPrefix) ||
            core.getInput(Inputs.GcpPrefix);

        if (gcpBucket) {
            cacheId = await gcsUtils.saveGcsCache(
                gcpBucket,
                gcpPrefix,
                cachePaths,
                primaryKey
